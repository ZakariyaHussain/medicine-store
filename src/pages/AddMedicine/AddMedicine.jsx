    ...
    const handleAddMedicineForm = async (e) => {
        ...
        try {
            ...
            const res = await axiosSecure.post(
                'https://medicine-store-seven.vercel.app/medicines',
                medicineData
            );
    ...
    return (
        <div className="p-10">
            <div className="text-center px-4 mb-10">
                ...
                <p>
                    Enter full details of the medicine product including
                    category, pricing, and dosage info.
                </p>
            </div>
            ...
            <form onSubmit={handleAddMedicineForm}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                        ...
                        <select
                            name="category"
                            className="select w-full bg-base-100 border border-base-300"
                        >
                ...
                <button
                    type="submit"
                    className="btn bg-[#20b4af] w-full mt-8"
                >
                    Add Medicine
                </button>
            </form>
